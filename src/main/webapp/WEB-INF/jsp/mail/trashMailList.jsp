		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container"
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">휴지통</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">휴지통</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
...
<!-- 									begin::Archive 답장으로 쓰거나 버리거나 -->
									...
									<a href="#" id="selectTrash" class="btn btn-sm btn-icon btn-light btn-active-light-primary mailDelete"
									...
									<div>
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
											...
											<div class="menu-item px-3">
												<a href="#" id="deleteCancel" class="menu-link px-3" data-kt-inbox-listing-filter="show_read">받은 메일함으로 이동</a>
											</div>
											<!--end::Menu item-->
											...
											<thead>
												<tr role="row">
													...
													<th data-dt-column="2" rowspan="1" colspan="1"
														...
														<span class="dt-column-title" role="button">보낼사람</span>
														<span class="dt-column-order"></span>
													</th>
													<th data-dt-column="3" rowspan="1" colspan="1"
														class="dt-orderable-asc dt-orderable-desc"
														aria-label="Title: Activate to sort" tabindex="0" style="width : 800px">
														...
														<c:forEach items="${mailList }" var="mail">
															...
															<tr>
																...
																<td class="min-w-80px">
																	...
																	<!--end::Star-->
																	<!--begin::휴지통-->
																	<a href="#" class="btn btn-icon btn-color-gray-500 btn-active-color-primary w-35px h-35px mailDelete"
																	data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Star" 
			...
			<!-- 																end::Avatar begin::보낸 사람 이름  -->
																...
																<td>
																	<div class="text-gray-900 gap-1 pt-2">
																		<!--begin::Heading-->
																		<a href="/mail/content/${mail.rec[0].receNo }" class="text-gray-900">
...
<!-- 																			begin::Heading -->
																			<a href="/mail/content/${mail.rec[0].receNo }" class="text-gray-900">
																				<c:if test="${empty mail.emailSj}">
																			   	    <span class="mail-link">(제목없음)</span>
																		        </c:if>
																				<c:if test="${not empty mail.emailSj}">
...
document.addEventListener("DOMContentLoaded", () => {
	...
	$("#deleteCancel").on("click", function(e) {
		...
		console.log("여기번호",sel);
		$(sel).each(function() {
			values += $(this).val()+",";
		})
		
		let url =  `/mail/delN/\${values}`;
		console.log("받은메일로!")
