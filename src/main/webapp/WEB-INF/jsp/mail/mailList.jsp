		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">받은편지함</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
											...
											<thead>
												<tr role="row">
													...
													<th data-dt-column="2" rowspan="1" colspan="1"
														...
														<span class="dt-column-title" role="button">보낸사람</span>
														<span class="dt-column-order"></span>
													</th>
														...
														<c:forEach items="${mailList }" var="mail">
															...
															<tr>
																...
																<td class="min-w-80px">
																	...
																	data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Star" 
																	data-no="${mail.rec[0].receNo }" data-bs-original-title="Star" data-kt-initialized="1">
																	...
																	<div class="text-gray-900 gap-1 pt-2">
																		...
																		<a href="/mail/content/${mail.rec[0].receNo }" class="text-gray-900">
																			...
																			<c:if test="${not empty mail.emailSj}">
																		        <c:if test="${not empty mail.atchFileNo }">
																				 ...
																				 <c:if test="${empty mail.atchFileNo }">
																	   	  			<span class="fw-bold mail-link">${mail.emailSj}</span>
																	   	  		</c:if>
																	       </c:if>
																		</a>
