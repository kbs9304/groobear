	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">기안 완료 문서</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">기안 완료 문서</li>
					<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
						<thead>
							<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
								...
								<th style="text-align: center;" class="min-w-100px">결재상태</th>
								<th style="text-align: center;" class="min-w-100px">기안일</th>
							</tr>
						</thead>
						...
						<c:if test="${empty scDocList }">
							<tr>
								<td colspan="5" style="text-align: center">완료된 결재 내역이 없습니다.</td>
							</tr>
						</c:if>
						</tbody>
					</table>
