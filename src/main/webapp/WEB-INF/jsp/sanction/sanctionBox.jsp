	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">결재 문서함</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">결재 문서함</li>
					<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
...
<!-- 						<input class="form-control form-control-solid w-100 mw-250px" placeholder="Pick date range" id="kt_ecommerce_report_shipping_daterangepicker" /> -->
				...
				<div class="card-body pt-0">
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
						...
						<c:if test="${not empty scDocList }">
						<c:forEach items="${scDocList }" var="scDocList">
							<tr>
								<td style="text-align: center;">${scDocList.sanctnDocNo}</td>
								<td style="text-align: center;">${scDocList.emplVo.deptNm}</td>
								<td style="text-align: center;">${scDocList.emplVo.emplNm}</td>
								<td style="text-align: center;">${scDocList.doorSign}</td>
								...
								<td data-order="${scDocList.recomDe}" style="text-align: center;">
								${scDocList.recomDe}
								</td>
							</tr>
						</c:forEach>
						</c:if>
						<c:if test="${empty scDocList }">
							<tr>
								<td colspan="5" style="text-align: center">등록된 결재 문서가 없습니다.</td>
							</tr>
						</c:if>
						</tbody>
					</table>
