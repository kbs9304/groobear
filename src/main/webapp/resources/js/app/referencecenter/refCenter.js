...
var KTFileManagerList = function () {
    ...
    const handleRename = () => {
        ...
        renameButton.forEach(button => {
            button.addEventListener('click', renameCallback); // 이름바꾸기 callback
        });
    }
